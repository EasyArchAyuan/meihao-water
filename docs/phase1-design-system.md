...
- 微信公众号：水邻居饮用水｜抖音：`TODO: REAL_DOUYIN_ACCOUNT`
...
```ts
// data/company.ts 关键值
legalName:        "廊坊美好水业有限公司"
establishedYear:  1998        // → 2026 实际 28 年，文案改用 "二十余年 / 自 1998 年起"
address:          "河北省廊坊市广阳区北凤道399号"  // 用户原始："廊坊市北凤道399号"
phones:           ["2805599", "2232111", "13393067179"]  // 全部为真实订水电话
wechatPublic:     "水邻居饮用水"   // 沿用
shuineighbor:     { name: "水邻居", domain: "TODO: REAL_DOMAIN" }
```

### B. 代理品牌（已确认 10 个）

`data/brands.ts` 已落地：**农夫山泉 / 怡宝 / 娃哈哈 / 恒大冰泉 / 昆仑山 / 汇源 / 水邻居天然矿泉水 / 水立方 / 冰露 / 百事可乐**。
