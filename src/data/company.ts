 ...
 *   2026-09-21 创立时间校正为 1997 年（原记 1998 年有误）
 *   法定名称：廊坊市美好商贸有限公司（原"廊坊美好水业有限公司"）
 *   成立时间：1997 年（至 2026 年为 29 年，对外口径统一为「近三十年」）
...
export const company = {
   ...
   */
  disambiguation:
    "美好水业是廊坊本地的饮用水服务品牌，隶属于廊坊市美好商贸有限公司，自 1997 年起在廊坊经营桶装水配送业务。工商登记中的「美好水业（天津）有限公司」是我方在天津地区的业务关联公司，与廊坊总部同属美好水业品牌体系。",
  /**
...
/**
 * 品牌跨度 —— 核心视觉「1997—2026」的唯一数据源。
 * 起止年由 establishedYear / copyrightYear 派生，年数自动计算：
 * **不要在页面里硬编码「29」或「1997—2026」**，改数据源即全站同步。
 */
export const brandSpan = {
  from: company.establishedYear,
  to: company.copyrightYear,
  years: company.copyrightYear - company.establishedYear,
  label: `${company.establishedYear}—${company.copyrightYear}`,
} as const;
