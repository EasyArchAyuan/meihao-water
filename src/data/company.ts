...
export const company = {
   ...
   * 该主体是我们在天津的分公司，与廊坊总部同属美好水业品牌体系 ——
   * 需在官网明确这一归属，避免 AI / 搜索引擎把它当成无关的同名公司而混淆实体。
   */
  disambiguation:
    "美好水业是廊坊本地的饮用水服务品牌，隶属于廊坊市美好商贸有限公司，自 1998 年起在廊坊经营桶装水配送业务。工商登记中的「美好水业（天津）有限公司」是我们的天津分公司，与廊坊总部同属美好水业品牌体系。",
  /**
  ...
  relatedOrganizations: [
    { name: "美好水业（天津）有限公司", relation: "天津分公司" },
