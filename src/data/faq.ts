...
export const faqItems: readonly FaqItem[] = [
  {
    ...
    answer: [
      ...
      `自有品牌「${company.shuineighbor.fullName}」于 2020 年上市，水源来自河北固安，具国家级绿色食品认证，并非代工贴牌的产品线。`,
    ],
  },
  {
    id: "entity",
  ...
  },
  {
    ...
    answer: [
      ...
      "公司自 1997 年起在廊坊经营，库房 5000 余平米，曾承接河北省辖区内高速公路服务区供水、廊坊开发区部分外企用水，以及北京盒马鲜生的饮用水仓配一体化服务。",
    ],
  },
  {
    id: "sanitation",
